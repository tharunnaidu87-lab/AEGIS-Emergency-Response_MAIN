...
def main():
    ...
    try:
        ...
        browser.send("Page.navigate", url=base + "/command")
        ...
        browser.send("Page.navigate", url=base + "/report")
        ...
        browser.send("Page.navigate", url=base + "/responder?unit=" + unit)
        ...
        browser.send("Page.navigate", url=base + "/command?report=DOES-NOT-EXIST")
        ...
        for route in ["/sms", "/call", "/responder", "/simulate", "/relocation"]:
            browser.send("Page.navigate", url=base + route)
        ...
        browser.send("Page.navigate", url=base + "/command?report=" + report_id)
        ...
        (ARTIFACTS / "browser-result.json").write_text(json.dumps({"passed": not exceptions, "report_id": report_id,
